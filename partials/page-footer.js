document.writeln(`
   <footer role="contentinfo" class="text-bg-secondary small">
      <h2 class="visually-hidden">Informasi Footer</h2>
         ...
         <div class="row row-gap-5 gx-md-5 justify-content-lg-between py-lg-3">
            <div class="col col-12 col-lg-auto order-lg-1 d-lg-flex flex-lg-column">
               ...
               <nav aria-label="navigasi sosial media" class="d-flex flex-wrap gap-3 flex-lg-grow-0">
                  <a href="#" target="_blank" rel="noopener" aria-label="tautan sosial media X Twitter">
                     <svg aria-hidden="true" width="2em" height="2em" viewBox="0 0 640 640"><path fill="currentColor" d="M453.2 112L523.8 112L369.6 288.2L551 528L409 528L297.7 382.6L170.5 528L99.8 528L264.7 339.5L90.8 112L236.4 112L336.9 244.9L453.2 112zM428.4 485.8L467.5 485.8L215.1 152L173.1 152L428.4 485.8z"></path></svg>
                  </a>
                  <a href="#" target="_blank" rel="noopener" aria-label="tautan sosial media Facebook">
                  ...
                  <a href="#" target="_blank" rel="noopener" aria-label="tautan sosial media Instagram">
                  ...
                  <a href="#" target="_blank" rel="noopener" aria-label="tautan sosial media Youtube">
                  ...
                  <a href="#" target="_blank" rel="noopener" aria-label="tautan sosial media Tiktok">
                  ...
                  <a href="#" target="_blank" rel="noopener" aria-label="tautan sosial media Linkedin-in">
            ...
            <div class="col col-12 col-md-6 col-lg-auto order-lg-3">
               ...
               <address aria-label="informasi alamat di kaki halaman" class="mb-0">
                  <a href="https://maps.app.goo.gl/QFxLopT45ZBAvngk6" target="_blank" class="ins">Jl. Semeru No. 133-135 Bambe, Kec. Driyorejo. Gresik 61177 Jawa Timur - Indonesia</a>
                  <br><br>
                  <b>T</b>. <a href="tel:+62317668777" target="_blank" class="ins">+62 31 766 8777</a>, <a href="tel:+62317667388" target="_blank" class="ins">766 7388</a>
                  <br>
      ...
      <div class="bg-dark py-4">
         <div class="container d-lg-flex justify-content-lg-between column-gap-lg-5">
            ...
            <ul class="list-unstyled d-flex flex-wrap gap-2 text-capitalize justify-content-lg-end">
               ...
               <li class="vr"></li>
               <li><a href="#" target="_blank" class="ins">syarat & ketentuan berlaku</a></li>
               <li class="vr"></li>
               <li><a href="#" target="_blank" class="ins">informasi keamanan data</a></li>
               <li class="vr"></li>
               <li><a href="#" target="_blank" class="ins">bantuan</a></li>
               <li class="vr"></li>
            </ul>
         </div>
      </div>
