         ...
         <div class="container flex-nowrap column-gap-4">
            ...
            <div class="navbar-collapse collapse">
               <ul class="list-unstyled mb-0 d-flex justify-content-center row-gap-1 column-gap-4 text-capitalize column-gap-xxl-5 mx-lg-auto">
                  ...
                  <li><a href="news.html" class="ins">berita & acara</a></li>
                  <li><a href="career.html" class="ins">karir</a></li>
               </ul>
            </div>

            <!-- Right tools -->
            <ul class="list-unstyled mb-0 d-flex column-gap-4 text-capitalize ms-lg-auto fs-5 align-items-center">
               <li>
                  <button class="theme-toggle btn rounded-0 p-0 border-0 shadow-none d-flex" aria-label="Ganti tema gelap atau terang" style="font-size: 1em;">
                     <svg aria-hidden="true" class="theme-icon" width="1em" height="1em" viewBox="0 0 24 24" fill="none">
                        <!-- Sun -->
                        <g class="icon-sun">
               ...
               <li class="d-none d-lg-block">
                  <a href="contact.html" aria-label="Kontak kami" class="d-flex">
                     <svg aria-hidden="true" width="1em" height="1em" viewBox="0 0 640 640"><path fill="currentColor" d="M224.2 89C216.3 70.1 195.7 60.1 176.1 65.4L170.6 66.9C106 84.5 50.8 147.1 66.9 223.3C104 398.3 241.7 536 416.7 573.1C493 589.3 555.5 534 573.1 469.4L574.6 463.9C580 444.2 569.9 423.6 551.1 415.8L453.8 375.3C437.3 368.4 418.2 373.2 406.8 387.1L368.2 434.3C297.9 399.4 241.3 341 208.8 269.3L253 233.3C266.9 222 271.6 202.9 264.8 186.3L224.2 89z"></path></svg>
                  </a>
               </li>
               <li class="d-none d-lg-block">
                  <a href="https://indracostore.com/" target="_blank" aria-label="Kunjungi toko resmi" class="d-flex">
                     <svg aria-hidden="true" width="1em" height="1em" viewBox="0 0 640 640"><path fill="currentColor" d="M94.7 136.3C101.6 112.4 123.5 96 148.4 96L492.4 96C517.3 96 539.2 112.4 546.2 136.3L569.6 216.5C582.4 260.2 549.5 304 504 304C477.7 304 454.6 289.1 443.2 266.9C431.6 288.8 408.6 304 381.8 304C355.2 304 332.1 289 320.5 267C308.9 289 285.8 304 259.2 304C232.4 304 209.4 288.9 197.8 266.9C186.4 289 163.3 304 137 304C91.4 304 58.6 260.3 71.4 216.5L94.7 136.3zM160.4 416L480.4 416L480.4 349.6C488 351.2 495.9 352 503.9 352C518.2 352 531.9 349.4 544.4 344.8L544.4 496C544.4 522.5 522.9 544 496.4 544L144.4 544C117.9 544 96.4 522.5 96.4 496L96.4 344.8C108.9 349.4 122.5 352 136.9 352C145 352 152.8 351.2 160.4 349.6L160.4 416z"></path></svg>
                  </a>
               </li>
               <li>
                  <a href="#" aria-label="Ubah bahasa Indonesia/ Inggris" class="d-flex text-decoration-none">en</a>
               </li>
            </ul>
            <button class="navbar-toggler rounded-0 p-0 border-0 shadow-none" data-bs-toggle="offcanvas" data-bs-target="#offcanvas-navigation" aria-controls="offcanvas-navigation" aria-label="Buka menu navigasi di selular">
